 ...
 *
 * Generated from http://github.com/GoogleChrome/accessibility-developer-tools/tree/40ed4b3a38cc327768497658211ddbee900830b0
 *
...
axs.Audit.accessibilityErrorMessage = function(a) {
  for (var b = a.rule.severity == axs.constants.Severity.SEVERE ? "Error: " : "Warning: ", b = b + (a.rule.code + " (" + a.rule.heading + ") failed on the following " + (1 == a.elements.length ? "element" : "elements")), b = 1 == a.elements.length ? b + ":" : b + (" (1 - " + a.elements.length + " of " + a.elements.length + "):"), c = a.elements.length, d = 0;d < c;d++) {
